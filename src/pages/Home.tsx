...
export default function Home(): JSX.Element {
  ...
  return (
    <div className='w-full flex flex-col items-center'>
      ...
      <hr className='w-full mt-2 mb-2' />
      <h1 className='w-full text-center font-semibold text-xl mt-10 mb-10'>Top Manxa</h1>
      <div className='flex flex-wrap gap-8 max-w-6xl items-center justify-center'>
        {data.data.results.slice(4).map((manxa: Manxa, i: number) => (
          <Link to={`/manxa/${extractSlug(manxa.url, "https://www.mangakakalot.gg/manga/")}`} key={i}>
