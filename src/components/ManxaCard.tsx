...
export default function ManxaCard({ manxa }: Props): JSX.Element {
    ...
    return (
        <Card className="max-w-44 max-h-72 pt-0 pb-3 border-0 hover:animate-pulse gap-3 rounded-md [@media(max-width:900px)]:max-w-36 [@media(max-width:900px)]:max-h-60">
